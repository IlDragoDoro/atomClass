...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Libros de tiempo libre</title>
  </head>
...
<?php foreach($conn->query ("SELECT * FROM libro WHERE genero = 'tiempoLibre'") as $row){?>
  <tr>
    <td><?php $img=$row['img']; echo "<img src='../img/libros/$img' width='50px'>" ?></td>
